...
class XOGame
{
  ...
  {
    return !board.is_full() && board.get_score(XOPlayer.PlayerX) == board.get_score(XOPlayer.PlayerO);
  }
  ...
  public void runGame()
  {
    ...
    int xScore = board.get_score(XOPlayer.PlayerX);
    int oScore = board.get_score(XOPlayer.PlayerO);
