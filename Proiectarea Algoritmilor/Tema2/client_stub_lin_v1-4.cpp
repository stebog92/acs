...
int main(int argc, char *argv[])
{
    ...
    printf("]\n");
	update_board (&my_board, read_message_size, buffer, (color)opponent(myColor));
...
//	scanf ("%c", &c);
    ...
    printf("Message sent!\n");
	update_board (&my_board, num, buffer, myColor);
	print_board(my_board);
	}
	close(sockfd);
	return 0;
