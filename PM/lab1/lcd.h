...
#define LcdD4			 PC0				// Pin-ul pentru firul de date D4 de pe LCD
#define LcdD5			 PC1				// Pin-ul pentru firul de date D5 de pe LCD
#define LcdD6			 PC2				// Pin-ul pentru firul de date D6 de pe LCD
#define LcdD7			 PC3				// Pin-ul pentru firul de date D7 de pe LCD

#define LcdRS			 PA0			    // Pinul pentru selectare operatie (LCD)
#define LcdRW			 PA1				// Pinul pentru Read/ Write (LCD)
#define LcdE			 PA2				// Pinul de Enable (LCD)
